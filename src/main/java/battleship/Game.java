...
public class Game {
    ...
    public void gameLogic() throws InterruptedException {
        ...
        boardFactory.manualPlacement(player1.getBoard().getOcean(), player1, "manual"); // TODO: Need to fix validation for placement, Carrier (1length) cannot be put at A1 UP and LEFT.
        ...
        boardFactory.manualPlacement(player2.getBoard().getOcean(), player2, "manual");
